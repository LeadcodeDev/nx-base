  ...
  return (
    <TableContext.Provider value={{ bleed, dense, grid, striped } as React.ContextType<typeof TableContext>}>
      <div className="flow-root">
        <div {...props} className={classNames(className, '-mx-[--gutter] overflow-x-auto whitespace-nowrap')}>
          <div className={classNames('inline-block min-w-full align-middle', !bleed && 'sm:px-[--gutter]')}>
...
export function TableHead({ className, ...props }: React.ComponentPropsWithoutRef<'thead'>) {
  return <thead className={classNames(className, 'text-zinc-500 dark:text-zinc-400')} {...props} />
}
...
export function TableCell({ className, children, ...props }: React.ComponentPropsWithoutRef<'td'>) {
  ...
  return (
    <td
      ...
      className={classNames(
        className,
        'relative px-4 first:pl-[var(--gutter)] last:pr-[var(--gutter)]',
