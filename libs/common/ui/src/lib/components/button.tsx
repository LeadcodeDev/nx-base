...
export const Button = React.forwardRef(function Button(
  ...
  const classes = classNames(
    className,
    styles.base,
    outline ? styles.outline : plain ? styles.plain : classNames(styles.solid, styles.colors[color ?? 'dark/zinc'])
  )
  ...
  return 'href' in props ? (
    ...
    <HeadlessButton {...props} className={classNames(classes, 'cursor-default')} ref={ref}>
      <TouchTarget>{children}</TouchTarget>
    </HeadlessButton>
  )
})
